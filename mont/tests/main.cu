...
namespace instance1
{
  ...
  const u32 a[WORDS] = BIG_INTEGER_CHUNKS8(0x8e2f1b9, 0x74caa8b2, 0xa201f5ce, 0xdd06a772, 0x33525f1a, 0xc8794b1e, 0x460dd0e8, 0x3abe291e);
  // 379489414366113194947093122905543766951565025151396298424585213707929480463
  const u32 b[WORDS] = BIG_INTEGER_CHUNKS8(0xd6c88c, 0xb2e981fc, 0x0acbd667, 0x745cc76e, 0x828cb275, 0xb3413d58, 0x35d4ba8a, 0xd2b36d0f);
  const u32 sum[WORDS] = BIG_INTEGER_CHUNKS8(0x9b9ba46, 0x27b42aae, 0xaccdcc36, 0x51636ee0, 0xb5df1190, 0x7bba8876, 0x7be28b73, 0x0d71962d);
  const u32 sum_mont[WORDS] = BIG_INTEGER_CHUNKS8(0x9b9ba46, 0x27b42aae, 0xaccdcc36, 0x51636ee0, 0xb5df1190, 0x7bba8876, 0x7be28b73, 0x0d71962d);
  const u32 sub[WORDS] = BIG_INTEGER_CHUNKS8(0x80c292c, 0xc1e126b6, 0x97361f67, 0x68a9e003, 0xb0c5aca5, 0x15380dc6, 0x1039165d, 0x680abc0f);
  const u32 sub_mont[WORDS] = BIG_INTEGER_CHUNKS8(0x80c292c, 0xc1e126b6, 0x97361f67, 0x68a9e003, 0xb0c5aca5, 0x15380dc6, 0x1039165d, 0x680abc0f);
  const u32 prod[WORDS * 2] = BIG_INTEGER_CHUNKS16(0x774ac, 0x40329d37, 0x4887cae6, 0xabcd9018, 0x5fbb6628, 0x03cbd7db, 0xc8d6bc53, 0xfd26ce8a,
                                                  0x65af4e11, 0x927fcb4e, 0x42fef4f7, 0xa5f0dbab, 0xcd81b0d6, 0x8d373fcc, 0xa68d257b, 0xc4a02ec2);
  const u32 prod_mont[WORDS] = BIG_INTEGER_CHUNKS8(0xa0b4f94, 0x130a8861, 0xaabacbd5, 0x67a95bc8, 0x940e2073, 0xad9f431c, 0x6e99ad03, 0x42f2abaa);
  const u32 a_square[WORDS * 2] = BIG_INTEGER_CHUNKS16(0x4ef84b, 0x46fd949c, 0x99569b59, 0x5297ce7c, 0x6a5d7232, 0x5b118f8f, 0x85c70946, 0xf18e468c, 0xb95b8544,
                                                      0x68c79459, 0x84d592ba, 0x629083cc, 0x4a7dddf0, 0xd1355ef4, 0x1e01fe42, 0xa7229f84);
  const u32 a_square_mont[WORDS] = BIG_INTEGER_CHUNKS8(0xdf5cb5a, 0x096834f9, 0x4a6de8da, 0xc658cfdf, 0xa741c620, 0x551a3a6c, 0xbfbc374c, 0xeeb5da6e);
  // a^b R mod m
...
namespace instance2
{
  ...
  const u32 a[WORDS] = BIG_INTEGER_CHUNKS8(0x10ce5690, 0x6268b3fc, 0x98655707, 0xf2924657, 0xc411e4e4, 0x67a23af3, 0x1d73262b, 0x21fb9cbc);
  // 4647671637959955902843015869877048340263466261541785797712932949582077663836
  const u32 b[WORDS] = BIG_INTEGER_CHUNKS8(0xa467d2a, 0x424b9042, 0x34e56518, 0x96c3bce9, 0x45cd6895, 0xdf44eaa7, 0xc97d7e3b, 0x90569a5c);
  const u32 sum[WORDS] = BIG_INTEGER_CHUNKS8(0x1b14d3ba, 0xa4b4443e, 0xcd4abc20, 0x89560341, 0x09df4d7a, 0x46e7259a, 0xe6f0a466, 0xb2523718);
  const u32 sum_mont[WORDS] = BIG_INTEGER_CHUNKS8(0x7bd09af, 0x933e4dcb, 0x6bc74528, 0xcaf94ecf, 0xe08a2121, 0x49df3f2d, 0x8ae7006a, 0x99005463);
  const u32 sub[WORDS] = BIG_INTEGER_CHUNKS8(0x687d966, 0x201d23ba, 0x637ff1ef, 0x5bce896e, 0x7e447c4e, 0x885d504b, 0x53f5a7ef, 0x91a50260);
  const u32 sub_mont[WORDS] = BIG_INTEGER_CHUNKS8(0x687d966, 0x201d23ba, 0x637ff1ef, 0x5bce896e, 0x7e447c4e, 0x885d504b, 0x53f5a7ef, 0x91a50260);
  const u32 prod[WORDS * 2] = BIG_INTEGER_CHUNKS16(0xacb004, 0xd5cbdba3, 0x591dd36a, 0x7ed69756, 0xf3480eea, 0xaa33697c, 0x149a2485, 0x707be2ca,
                                                  0x7a7cb2d0, 0x8ce8f496, 0x220d4021, 0xf2d0727f, 0x5a1ce3c9, 0xe9685c76, 0xbfe043f5, 0xf9dd6b90);
  const u32 prod_mont[WORDS] = BIG_INTEGER_CHUNKS8(0xa4d8112, 0xe4160087, 0x732df738, 0x92988df5, 0x358c970e, 0x34dfabf9, 0x3c172b02, 0xba57ea39);
  const u32 a_square[WORDS * 2] = BIG_INTEGER_CHUNKS16(0x11a7121, 0x79f0ca8e, 0x721e7528, 0xb80c8b72, 0x3fb1eceb, 0x3825c3e1, 0x0b0c3d7d, 0x36bbf5e6,
                                                      0xc3c79c07, 0x3f169f49, 0xb48894fd, 0xe2fef33b, 0x858ed52b, 0x42c51bd4, 0x8a794cdd, 0x309daa10);
  const u32 a_square_mont[WORDS] = BIG_INTEGER_CHUNKS8(0xcc71e43, 0x5420feed, 0xca1a0867, 0xa0807fcd, 0x1948fd76, 0xb4ad5ad7, 0x93ad57f9, 0x6b7942d5);
  // a^b R mod m
  const u32 pow_mont[WORDS] = BIG_INTEGER_CHUNKS8(0x10c99ac6, 0xb563f419, 0x8775e73e, 0x5ce7be6f, 0xaa2bf8d0, 0x54a445fa, 0xaa6941d2, 0x614f6e74);
  const u32 a_inv_mont[WORDS] = BIG_INTEGER_CHUNKS8(0xb6ebbd1, 0xc0fd36a5, 0xad4f0ad6, 0x4c55c6f2, 0xe6eba872, 0xaf521f6e, 0x24ef45dc, 0xc51967b2);
  const u32 a_slr125[WORDS] = BIG_INTEGER_CHUNKS8(0x0, 0x0, 0x0, 0x0, 0x8672b483, 0x13459fe4, 0xc32ab83f, 0x949232be);
...
{
  const u32 x[WORDS] = BIG_INTEGER_CHUNKS8(0xf87ecc5, 0x4ffca37c, 0x180a10f6, 0x4e41de59, 0x69467642, 0x88d72303, 0x354d1651, 0xbdd2cbc4);
  const u32 x_mont[WORDS] = BIG_INTEGER_CHUNKS8(0x4226847, 0xbc719d69, 0x4de580ff, 0x9a26805e, 0xfc3ff9c8, 0xabef6da5, 0x948971bc, 0x76bb9582);
