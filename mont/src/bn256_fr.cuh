...
namespace bn256_fr
{
    ...
    namespace device_constants
    {
        ...
        const __device__ Number m_prime_wide = BIG_INTEGER_CHUNKS8(0x73f82f1d, 0x0d8341b2, 0xe39a9828, 0x99062391, 0x6586864b, 0x4c6911b3, 0xc2e1f593, 0xefffffff);
    }
    ...
    namespace host_constants
    {
        ...
        const Number m_prime_wide = BIG_INTEGER_CHUNKS8(0x73f82f1d, 0x0d8341b2, 0xe39a9828, 0x99062391, 0x6586864b, 0x4c6911b3, 0xc2e1f593, 0xefffffff);
    }
